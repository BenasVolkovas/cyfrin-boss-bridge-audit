...
contract L1BossBridge is Ownable, Pausable, ReentrancyGuard {
    ...
    // @question is public necessary?
    // @todo @audit should be constant
    uint256 public DEPOSIT_LIMIT = 100_000 ether;

    // @note this bridge's token
     ...
     */
    // @todo @audit-high If user A approves the bridge to spend tokens, user B can steal funds
    // @todo @audit-high User can infinitely deposit tokens in L2 by providing vault address as from
     ...
     */
    // @todo @audit-high signature replay attack
    ...
    function sendToL1(
        ...
        // @question slither found vulnerability here. Is it ok?
